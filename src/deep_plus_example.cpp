...
int main(int argc, char* argv[]) {
    ...
    std::unordered_map<std::string, L3OrderBook> order_books = {
            {"TSLA", L3OrderBook(20000, 100.0, 300.0, 0.01)},
            {"AAPL", L3OrderBook(20000, 120.0, 180.0, 0.05)},
            // You can add more entries for other stocks
        };
